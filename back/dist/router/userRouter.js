...
exports.router = (function (express_router) {
    ...
    Router.route('/signup')
        .post(multer_config_1["default"], function (req, res, next) { return UserController_1["default"].signup(req, res, next); });
    Router.route('/signin')
    ...
    Router.route('/update/:email')
        .put(function (req, res, next) { return Auth_1["default"].verifAuth(req, res, next); }, multer_config_1["default"], function (req, res, next) { return UserController_1["default"].update(req, res, next); });
    return Router;
})(express.Router);
