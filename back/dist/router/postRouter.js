...
var multer_config_1 = require("../../dist/middleware/multer-config");
exports.router = (function (express_router) {
    var Router = express_router();
    Router.route("/add")
        .post(function (req, res, next) { return Auth_1["default"].verifAuth(req, res, next); }, multer_config_1.postMulter, function (req, res, next) { return PostController_1["default"].create(req, res, next); });
    Router.route("/all")
